...
original_author="rpozdeev"
original_name="wealth"
original_urlname="wealth"
original_description="Awesome wealth created by rpozdeev" 
...
then
    ...
    echo "then run 'wealth' or 'python -m wealth'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'wealth' or 'python -m wealth' or 'poetry run wealth'"
fi
